...
app = Flask(__name__)
dir_to_test = '/Users/leeshinhee/Desktop/static_test/'
...
def predict_in_derectory():
  ...
  result = []
  result.append(f'Predictions per class:\n {predictions_classes.numpy()}')
  result.append(f'Predictions:\n{predictions.numpy()}')
  result.append(f'Labels:\n {label_batch}')
